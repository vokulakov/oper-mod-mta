...
function toggleCruiseSpeed ()
	...
	if not cruiseSpeedEnabled then
		...
		triggerServerEvent ("operVehicleSystem.enableVehicleCruiseSpeed", theVehicle, true);
		...
		triggerServerEvent ("operVehicleSystem.enableVehicleCruiseSpeed",  getPedOccupiedVehicle (getLocalPlayer ()), false);
	...
	setElementData(theVehicle, "vehicle.cruiseSpeedEnabled", cruiseSpeedEnabled)
end
addEvent("operVehicleSystem.toggleCruiseSpeed", true)
addEventHandler ("operVehicleSystem.toggleCruiseSpeed", getRootElement (), toggleCruiseSpeed)
