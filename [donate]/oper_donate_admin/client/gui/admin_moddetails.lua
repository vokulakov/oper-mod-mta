...
function aViewModdetails ( player )
	...
	if ( aModdetailsForm == nil ) then
		...
		aModdetailsList		= guiCreateGridList ( 0.02, 0.09, 0.72, 0.85, true, aModdetailsForm )
					   ...
					   guiGridListAddColumn( aModdetailsList, "Название", 0.60 )
		aModdetailsRefresh	= guiCreateButton ( 0.76, 0.78, 0.32, 0.05, "Обновить", true, aModdetailsForm )
		aModdetailsClose	= guiCreateButton ( 0.76, 0.85, 0.32, 0.05, "Закрыть", true, aModdetailsForm )
