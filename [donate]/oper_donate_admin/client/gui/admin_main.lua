...
function aAdminMenu ()
	if ( aAdminForm == nil ) then
		...
		aAdminForm			= guiCreateWindow ( x / 2 - 310, y / 2 - 260, 620, 520, "", false )
						  ...
						  guiCreateLabel ( 0.75, 0.05, 0.45, 0.04, "", true, aAdminForm )
		...
		aTab1.PlayerListSearch 	= guiCreateEdit ( 0.03, 0.05, 0.16, 0.04, "", true, aTab1.Tab )
						  guiCreateStaticImage ( 0.2, 0.05, 0.035, 0.04, "client\\images\\search.png", true, aTab1.Tab )
		...
		aTab1.Shout			= guiCreateButton ( 0.71, 0.2, 0.28, 0.07, "Написать сообщение\nна экране", true, aTab1.Tab, "shout" )
		...
		aTab1.Accountname	= guiCreateLabel ( 0.26, 0.170, 0.435, 0.035, "Аккаунт: N/A", true, aTab1.Tab )
		...
		aTab1.CountryCode	= guiCreateLabel ( 0.45, 0.170, 0.04, 0.035, "", true, aTab1.Tab )
						  guiCreateHeader ( 0.25, 0.245, 0.20, 0.04, "Игра:", true, aTab1.Tab )
		aTab1.Health		= guiCreateLabel ( 0.26, 0.290, 0.20, 0.04, "Здоровье: 0%", true, aTab1.Tab )
		aTab1.Armour		= guiCreateLabel ( 0.45, 0.290, 0.20, 0.04, "Броня: 0%", true, aTab1.Tab )
		aTab1.Skin			= guiCreateLabel ( 0.26, 0.335, 0.20, 0.04, "Скин: N/A", true, aTab1.Tab )
		--aTab1.Team			= guiCreateLabel ( 0.45, 0.440, 0.20, 0.04, "Команда: Нет", true, aTab1.Tab )
		aTab1.Weapon		= guiCreateLabel ( 0.26, 0.380, 0.35, 0.04, "Оружие: N/A", true, aTab1.Tab )
		...
		aTab1.SetStats		= guiCreateButton ( 0.85, 0.395, 0.13, 0.07, "Править статистику", true, aTab1.Tab, "setstat" )
		...
		aTab1.WarpTo		= guiCreateButton ( 0.71, 0.68, 0.27, 0.04, "Телепорт игрока к..", true, aTab1.Tab, "warp" )
						  guiCreateHeader ( 0.25, 0.455, 0.20, 0.04, "Автомобиль:", true, aTab1.Tab )
		aTab1.Vehicle		= guiCreateLabel ( 0.26, 0.500, 0.6, 0.04, "Автомобиль: N/A", true, aTab1.Tab )
		aTab1.VehicleHealth	= guiCreateLabel ( 0.26, 0.545, 0.25, 0.04, "Здоровье автомобиля: 0%", true, aTab1.Tab )
		aTab1.VehicleFix		= guiCreateButton ( 0.26, 0.635, 0.3, 0.04, "Починить транспорт", true, aTab1.Tab, "repair" )
		aTab1.VehicleDestroy	= guiCreateButton ( 0.26, 0.68, 0.3, 0.04, "Отнять транспорт", true, aTab1.Tab, "destroyvehicle" )
		aTab1.VehicleBlow		= guiCreateButton ( 0.26, 0.725, 0.3, 0.04, "Взорвать транспорт", true, aTab1.Tab, "blowvehicle" )
		...
		aTab5.AdminChat		= guiCreateMemo ( 0.03, 0.05, 0.7, 0.85, "", true, aTab5.Tab )
						  guiSetProperty ( aTab5.AdminChat, "ReadOnly", "true" )
		aTab5.AdminPlayers	= guiCreateGridList ( 0.75, 0.05, 0.23, 0.80, true, aTab5.Tab )
						  guiGridListAddColumn ( aTab5.AdminPlayers, "Админы", 0.88 )
		aTab5.AdminChatSound	= guiCreateCheckBox ( 0.75, 0.86, 0.18, 0.04, "Вкл. звук", true, true, aTab5.Tab )
		aTab5.AdminText		= guiCreateEdit ( 0.03, 0.92, 0.7, 0.06, "", true, aTab5.Tab )
		aTab5.AdminSay		= guiCreateButton ( 0.75, 0.92, 0.23, 0.06, "Отправить", true, aTab5.Tab )
...
function aClientAdminChat ( message )
	...
	outputChatBox ( "[Админ чат]> "..getPlayerName ( source )..": "..message, 255, 0, 0 )
